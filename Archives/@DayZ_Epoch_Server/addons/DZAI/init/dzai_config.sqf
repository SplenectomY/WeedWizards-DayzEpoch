...
//Spawn probabilities
DZAI_spawnChance0 = 0.60;	//Spawn chance for low-skill AI typically found in small towns (Default: 0.40)
DZAI_spawnChance1 = 0.70;	//Spawn chance for mid-level AI typically found in cities and large towns (Default: 0.60)
...
//Set minimum and maximum wait time in seconds to respawn an AI vehicle patrol after vehicle is destroyed or disabled. (Default: Min 600, Max 900).
DZAI_respawnTMinL = 3600;
DZAI_respawnTMaxL = 7200;
