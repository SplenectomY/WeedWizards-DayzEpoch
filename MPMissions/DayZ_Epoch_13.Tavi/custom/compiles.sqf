...
if (!isDedicated) then {
	...
	player_weaponFiredNear =		compile preprocessFileLineNumbers "custom\player_weaponFiredNear.sqf";
	...
	player_antiWall =			compile preprocessFileLineNumbers "custom\player_antiWall.sqf";
