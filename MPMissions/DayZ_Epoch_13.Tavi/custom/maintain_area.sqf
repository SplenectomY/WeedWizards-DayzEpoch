...
_requirements = [];
switch true do {
	case (_count <= 10):  {_requirements = [["ItemSilverBar",1]]};
	case (_count <= 20):  {_requirements = [["ItemSilverBar2oz",1]]};
	case (_count <= 35):  {_requirements = [["ItemSilverBar3oz",1]]};
	case (_count <= 50):  {_requirements = [["ItemSilverBar4oz",1]]};
	case (_count <= 75):  {_requirements = [["ItemSilverBar5oz",1]]};
	case (_count <= 100): {_requirements = [["ItemSilverBar6oz",1]]};
	case (_count <= 175): {_requirements = [["ItemSilverBar7oz",1]]};
	case (_count <= 250): {_requirements = [["ItemSilverBar8oz",1]]};
	case (_count <= 325): {_requirements = [["ItemSilverBar9oz",1]]};
	case (_count <= 400): {_requirements = [["ItemSilverBar10oz",1]]};
	case (_count <= 475): {_requirements = [["ItemSilverBar10oz",2]]};
	case (_count <= 550): {_requirements = [["ItemSilverBar10oz",3]]};
	case (_count <= 625): {_requirements = [["ItemSilverBar10oz",4]]};
	case (_count > 625):  {_requirements = [["ItemSilverBar10oz",5]]};
};
